...
namespace Nzl.Smth.Controls.Containers
{
    ...
    /// </summary>
#if (DESIGNMODE)
    public partial class ThreadControlContainerSrc : UserControl
#else
    public partial class ThreadControlContainerSrc : BaseControlContainer<ThreadControl, Thread>
#endif
    {
#if (DESIGNMODE)
#else
        ...
        /// Ctor.
        /// </summary>
        public ThreadControlContainerSrc()
        {
            InitializeComponent();
